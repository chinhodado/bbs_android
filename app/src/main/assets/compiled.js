...
var BattleGraphic = (function () {
    ...
    BattleGraphic.wr = (1 /* IS_MOBILE */ && typeof window !== 'undefined') ? window.innerWidth / 400 : 1;
    BattleGraphic.hr = (1 /* IS_MOBILE */ && typeof window !== 'undefined') ? window.innerHeight / 600 : 1;
...
(function (ENUM) {
    (function (Setting) {
        Setting[Setting["IS_MOBILE"] = 1] = "IS_MOBILE";
...
var RangeFactory = (function () {
    ...
    RangeFactory.getRange = function (id, selectDead) {
        ...
        var range;
        if (this.isEnemyRandomRange(id) && id != 18 /* ENEMY_REAR_RANDOM_3 */) {
    ...
    RangeFactory.isEnemyRandomRange = function (id) {
        return !!RangeFactory.ENEMY_RANDOM_RANGE_TARGET_NUM[id] || id == 18 /* ENEMY_REAR_RANDOM_3 */;
    };
...
var EnemyRearRandom3Range = (function (_super) {
    __extends(EnemyRearRandom3Range, _super);
    function EnemyRearRandom3Range() {
        _super.apply(this, arguments);
    }
    EnemyRearRandom3Range.prototype.getReady = function (executor) {
        this.numProcessed = 0;
    };

    EnemyRearRandom3Range.prototype.getTarget = function (executor) {
        var tmpRange = RangeFactory.getRange(14 /* ENEMY_REAR_ALL */);
    ...
    EnemyRearRandom3Range.NUM_TARGET = 3;
    return EnemyRearRandom3Range;
})(RandomRange);
